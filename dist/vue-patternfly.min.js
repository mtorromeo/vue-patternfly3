...
!function() {
  ...
  d3_class(d3_Map, {
    ...
    values: function() {
      ...
      var values = [];
      for (var key in this._) { values.push(this$1._[key]); }
      return values;
    },
    entries: function() {
      var this$1 = this;
    ...
    forEach: function(f) {
      ...
      for (var key in this._) { f.call(this$1, d3_map_unescape(key), this$1._[key]); }
    }
  });
  ...
  d3_class(d3_Set, {
    ...
    forEach: function(f) {
      ...
      for (var key in this._) { f.call(this$1, d3_map_unescape(key)); }
    }
  });
  d3.behavior = {};
  ...
  d3.rebind = function(target, source) {
    ...
    while (++i < n) { target[method = arguments$1[i]] = d3_rebind(target, source, source[method]); }
    return target;
  };
  ...
  d3.dispatch = function() {
    ...
    while (++i < n) { dispatch[arguments$1[i]] = d3_dispatch_event(dispatch); }
    return dispatch;
  };
  ...
  d3_dispatch.prototype.on = function(type, listener) {
    ...
    if (arguments.length === 2) {
      if (listener == null) { for (type in this) {
        if (this$1.hasOwnProperty(type)) { this$1[type].on(name, null); }
      } }
      return this;
    }
  };
  function d3_dispatch_event(dispatch) {
    ...
    function event() {
      ...
      while (++i < n) { if (l = z[i].on) { l.apply(this$1, arguments$1); } }
      return dispatch;
    }
  ...
  d3_selectionPrototype.select = function(selector) {
    ...
    for (var j = -1, m = this.length; ++j < m; ) {
      ...
      subgroup.parentNode = (group = this$1[j]).parentNode;
  ...
  d3_selectionPrototype.attr = function(name, value) {
    ...
    if (arguments.length < 2) {
      ...
      for (value in name) { this$1.each(d3_selection_attr(value, name[value])); }
      return this;
    }
  ...
  d3_selectionPrototype.classed = function(name, value) {
    ...
    if (arguments.length < 2) {
      ...
      for (value in name) { this$1.each(d3_selection_classed(value, name[value])); }
      return this;
    }
  ...
  function d3_selection_classed(name, value) {
    ...
    function classedConstant() {
      ...
      var i = -1;
      while (++i < n) { name[i](this$1, value); }
    }
    function classedFunction() {
      var this$1 = this;

      var i = -1, x = value.apply(this, arguments);
      while (++i < n) { name[i](this$1, x); }
    }
  ...
  d3_selectionPrototype.style = function(name, value, priority) {
    ...
    if (n < 3) {
      if (typeof name !== "string") {
        if (n < 2) { value = ""; }
        for (priority in name) { this$1.each(d3_selection_style(priority, name[priority], value)); }
        return this;
      }
      if (n < 2) {
        var node = this.node();
  ...
  d3_selectionPrototype.property = function(name, value) {
    ...
    if (arguments.length < 2) {
      ...
      for (value in name) { this$1.each(d3_selection_property(value, name[value])); }
      return this;
    }
  ...
  d3_selectionPrototype.data = function(value, key) {
    ...
    if (typeof value === "function") {
      while (++i < n) {
        bind(group = this$1[i], value.call(group, group.parentNode.__data__, i));
      }
    } else {
      while (++i < n) {
        bind(group = this$1[i], value);
      }
    }
  ...
  d3_selectionPrototype.sort = function(comparator) {
    ...
    for (var j = -1, m = this.length; ++j < m; ) { this$1[j].sort(comparator); }
    return this.order();
  };
  ...
  d3_selectionPrototype.on = function(type, listener, capture) {
    ...
    if (n < 3) {
      if (typeof type !== "string") {
        ...
        for (capture in type) { this$1.each(d3_selection_on(capture, type[capture], listener)); }
        return this;
      }
    ...
    function removeAll() {
      ...
      for (var name in this) {
        if (match = name.match(re)) {
          var l = this$1[name];
          this$1.removeEventListener(match[1], l, l.$);
          delete this$1[name];
        }
      }
    }
  ...
  function d3_time_formatMulti(formats) {
    ...
    while (++i < n) { formats[i][0] = this$1(formats[i][0]); }
  ...
  d3.geom.hull = function(vertices) {
    ...
    function hull(data) {
      ...
      for (i = 0; i < n; i++) {
        points.push([ +fx.call(this$1, data[i], i), +fy.call(this$1, data[i], i), i ]);
      }
      ...
      while (parent && parent.C) {
        ...
        if (parent === grandpa.L) {
          ...
          if (uncle && uncle.C) {
            ...
            if (after === parent.R) {
              d3_geom_voronoiRedBlackRotateLeft(this$1, parent);
              after = parent;
              parent = after.U;
            }
            parent.C = false;
            grandpa.C = true;
            d3_geom_voronoiRedBlackRotateRight(this$1, grandpa);
          }
        } else {
          uncle = grandpa.L;
          if (uncle && uncle.C) {
            ...
            if (after === parent.L) {
              d3_geom_voronoiRedBlackRotateRight(this$1, parent);
              after = parent;
              parent = after.U;
            }
            parent.C = false;
            grandpa.C = true;
            d3_geom_voronoiRedBlackRotateLeft(this$1, grandpa);
          }
        }
        parent = after.U;
      }
        ...
        if (node === parent.L) {
          ...
          if (sibling.L && sibling.L.C || sibling.R && sibling.R.C) {
            if (!sibling.R || !sibling.R.C) {
              sibling.L.C = false;
              sibling.C = true;
              d3_geom_voronoiRedBlackRotateRight(this$1, sibling);
              sibling = parent.R;
            }
            sibling.C = parent.C;
          ...
          if (sibling.L && sibling.L.C || sibling.R && sibling.R.C) {
            if (!sibling.L || !sibling.L.C) {
              sibling.R.C = false;
              sibling.C = true;
              d3_geom_voronoiRedBlackRotateLeft(this$1, sibling);
              sibling = parent.L;
            }
            sibling.C = parent.C;
  ...
  d3.layout.force = function() {
    ...
    force.start = function() {
      ...
      distances = [];
      if (typeof linkDistance === "function") { for (i = 0; i < m; ++i) { distances[i] = +linkDistance.call(this$1, links[i], i); } } else { for (i = 0; i < m; ++i) { distances[i] = linkDistance; } }
      strengths = [];
      if (typeof linkStrength === "function") { for (i = 0; i < m; ++i) { strengths[i] = +linkStrength.call(this$1, links[i], i); } } else { for (i = 0; i < m; ++i) { strengths[i] = linkStrength; } }
      charges = [];
      if (typeof charge === "function") { for (i = 0; i < n; ++i) { charges[i] = +charge.call(this$1, nodes[i], i); } } else { for (i = 0; i < n; ++i) { charges[i] = charge; } }
  ...
  function d3_svg_line(projection) {
    ...
    function line(data) {
      ...
      while (++i < n) {
        if (defined.call(this$1, d = data[i], i)) {
          points.push([ +fx.call(this$1, d, i), +fy.call(this$1, d, i) ]);
  ...
  function d3_svg_area(projection) {
    ...
    function area(data) {
      ...
      while (++i < n) {
        if (defined.call(this$1, d = data[i], i)) {
          points0.push([ x = +fx0.call(this$1, d, i), y = +fy0.call(this$1, d, i) ]);
          points1.push([ +fx1.call(this$1, d, i), +fy1.call(this$1, d, i) ]);
  ...
  d3_transitionPrototype.attr = function(nameNS, value) {
    ...
    if (arguments.length < 2) {
      for (value in nameNS) { this$1.attr(value, nameNS[value]); }
      return this;
    }
  ...
  d3_transitionPrototype.style = function(name, value, priority) {
    ...
    if (n < 3) {
      if (typeof name !== "string") {
        if (n < 2) { value = ""; }
        for (priority in name) { this$1.style(priority, name[priority], value); }
        return this;
      }
      priority = "";
    }
...
(function (window) {
    ...
    function ChartInternal(api) {
        var $$ = this;
        $$.d3 = window.d3 ? window.d3 : typeof commonjsRequire !== 'undefined' ? d3 : undefined;
        $$.api = api;
    ...
    c3_chart_internal_fn.initParams = function () {
        var $$ = this, d3$$1 = $$.d3, config = $$.config;
    ...
    c3_chart_internal_fn.redraw = function (options, transitions) {
        var $$ = this, main = $$.main, d3$$1 = $$.d3, config = $$.config;
        ...
        if ((duration || flow) && $$.isTabVisible()) { // Only use transition if tab visible. See #938.
            ...
            d3$$1.transition().duration(duration).each(function () {
                ...
                [
                    ...
                    $$.redrawRegion(true),
                    $$.redrawGrid(true) ].forEach(function (transitions) {
        ...
        eventRectEnter.append("rect")
            ...
            .call(
                config.data_selection_draggable && $$.drag ? (
                    d3$$1.behavior.drag().origin(Object)
                        .on('drag', function () { $$.drag(d3$$1.mouse(this)); })
                        .on('dragstart', function () { $$.dragstart(d3$$1.mouse(this)); })
    ...
    c3_chart_internal_fn.updateArea = function (durationForExit) {
        ...
        $$.mainArea.enter().append('path')
            ...
            .style("fill", $$.color)
            .style("opacity", function () { $$.orgAreaOpacity = +d3$$1.select(this).style('opacity'); return 0; });
        $$.mainArea
    ...
    c3_chart_internal_fn.isWithinCircle = function (that, r) {
        var d3$$1 = this.d3,
            mouse = d3$$1.mouse(that), d3_this = d3$$1.select(that),
    ...
    c3_chart_internal_fn.initGrid = function () {
        var $$ = this, config = $$.config, d3$$1 = $$.d3;
        $$.grid = $$.main.append('g')
    ...
    c3_chart_internal_fn.updateXGrid = function (withoutUpdate) {
        ...
        if (!withoutUpdate) {
            $$.xgrid.attr($$.xgridAttr)
                .style("opacity", function () { return +d3$$1.select(this).attr(config.axis_rotated ? 'y1' : 'x1') === (config.axis_rotated ? $$.height : 0) ? 0 : 1; });
        }
        $$.xgrid.exit().remove();
    };
    ...
    c3_chart_internal_fn.revertLegend = function () {
        ...
        $$.legend.selectAll('.' + CLASS.legendItem)
            ...
            .transition().duration(100)
            .style('opacity', function () { return $$.opacityForLegend(d3$$1.select(this)); });
    };
    ...
    c3_chart_internal_fn.redrawArc = function (duration, durationForExit, withTransform) {
        var $$ = this, d3$$1 = $$.d3, config = $$.config, main = $$.main,
            mainArc;
    ...
    c3_chart_internal_fn.drag = function (mouse) {
        var $$ = this, config = $$.config, main = $$.main, d3$$1 = $$.d3;
    ...
    c3_chart_internal_fn.toggleShape = function (that, d, i) {
        var $$ = this, d3$$1 = $$.d3, config = $$.config,
            shape = d3$$1.select(that), isSelected = shape.classed(CLASS.SELECTED),
    ...
    c3_chart_internal_fn.initBrush = function () {
        var $$ = this, d3$$1 = $$.d3;
        $$.brush = d3$$1.svg.brush().on("brush", function () { $$.redrawForBrush(); });
    ...
    c3_chart_internal_fn.initZoom = function () {
        var $$ = this, d3$$1 = $$.d3, config = $$.config, startEvent;

        $$.zoom = d3$$1.behavior.zoom()
    ...
    c3_chart_internal_fn.redrawForZoom = function () {
        var $$ = this, d3$$1 = $$.d3, config = $$.config, zoom = $$.zoom, x = $$.x;
    ...
    c3_chart_internal_fn.generateColor = function () {
        var $$ = this, config = $$.config, d3$$1 = $$.d3,
            ...
            pattern = notEmpty(config.color_pattern) ? config.color_pattern : d3$$1.scale.category10().range(),
    ...
    c3_chart_internal_fn.hasCaches = function (ids) {
        ...
        for (var i = 0; i < ids.length; i++) {
            if (! (ids[i] in this$1.cache)) { return false; }
        }
        return true;
    };
    ...
    c3_chart_internal_fn.getCaches = function (ids) {
        ...
        var targets = [], i;
        for (i = 0; i < ids.length; i++) {
            if (ids[i] in this$1.cache) { targets.push(this$1.cloneTarget(this$1.cache[ids[i]])); }
        }
        return targets;
    };
    ...
    c3_chart_fn.zoom.max = function (max) {
        var $$ = this.internal, config = $$.config, d3$$1 = $$.d3;
        if (max === 0 || max) {
    ...
    c3_chart_fn.selected = function (targetId) {
        var $$ = this.internal, d3$$1 = $$.d3;
        return d3$$1.merge(
            $$.main.selectAll('.' + CLASS.shapes + $$.getTargetSelectorSuffix(targetId)).selectAll('.' + CLASS.shape)
                .filter(function () { return d3$$1.select(this).classed(CLASS.SELECTED); })
                .map(function (d) { return d.map(function (d) { var data = d.__data__; return data.data ? data.data : data; }); })
        );
    };
    c3_chart_fn.select = function (ids, indices, resetOther) {
        var $$ = this.internal, d3$$1 = $$.d3, config = $$.config;
        if (! config.data_selection_enabled) { return; }
        $$.main.selectAll('.' + CLASS.shapes).selectAll('.' + CLASS.shape).each(function (d, i) {
            var shape = d3$$1.select(this), id = d.data ? d.data.id : d.id,
    ...
    function c3_axis(d3$$1, params) {
        var scale = d3$$1.scale.linear(), orient = "bottom", innerTickSize = 6, outerTickSize, tickPadding = 3, tickValues = null, tickFormat, tickArguments;
         ...
         SVGPathSegList.prototype._parsePath = function(string) {
             ...
             Source.prototype._parseNumber = function() {
                 ...
                 while (this._currentIndex < this._endIndex && this._string.charAt(this._currentIndex) >= "0" && this._string.charAt(this._currentIndex) <= "9")
                     { this$1._currentIndex++; } // Advance to first non-digit.

                 if (this._currentIndex != startIntPartIndex) {
                     var scanIntPartIndex = this._currentIndex - 1;
                     var multiplier = 1;
                     while (scanIntPartIndex >= startIntPartIndex) {
                         integer += multiplier * (this$1._string.charAt(scanIntPartIndex--) - "0");
                         multiplier *= 10;
                     }
                 }
                 ...
                 if (this._currentIndex < this._endIndex && this._string.charAt(this._currentIndex) == ".") {
                     ...
                     if (this._currentIndex >= this._endIndex || this._string.charAt(this._currentIndex) < "0" || this._string.charAt(this._currentIndex) > "9")
                         { return undefined; }
                     while (this._currentIndex < this._endIndex && this._string.charAt(this._currentIndex) >= "0" && this._string.charAt(this._currentIndex) <= "9")
                         { decimal += (this$1._string.charAt(this$1._currentIndex++) - "0") * (frac *= 0.1); }
                 }
                 ...
                 if (this._currentIndex != startIndex && this._currentIndex + 1 < this._endIndex && (this._string.charAt(this._currentIndex) == "e" || this._string.charAt(this._currentIndex) == "E") && (this._string.charAt(this._currentIndex + 1) != "x" && this._string.charAt(this._currentIndex + 1) != "m")) {
                     ...
                     while (this._currentIndex < this._endIndex && this._string.charAt(this._currentIndex) >= "0" && this._string.charAt(this._currentIndex) <= "9") {
                         exponent *= 10;
                         exponent += (this$1._string.charAt(this$1._currentIndex) - "0");
                         this$1._currentIndex++;
                     }
                 }
...
var NodeList = function NodeList (args) {
  var this$1 = this;
...
var prototypeAccessors = { asArray: {} };

NodeList.prototype.concat = function concat () {
    var arguments$1 = arguments;
...
NodeList.prototype.delete = function delete$1 () {
...
NodeList.prototype.each = function each () {
...
NodeList.prototype.find = function find (element) {
  var nodes = [];
  flatten(this).forEach(function (node) { nodes.push.apply(nodes, node.querySelectorAll(element)); });
  return NodeListJS(nodes, this.owner)
};
NodeList.prototype.findChildren = function findChildren (element) {
    var this$1 = this;

  if (element) { return this.find(element).filter(function (el) { return this$1.includes(el.parentElement); }) }
  return flatten(this.map(function (el) { return el.children; }))
};
NodeList.prototype.forEach = function forEach () {
  ArrayProto.forEach.apply(this, arguments);
  return this
};
NodeList.prototype.includes = function includes (element, index) {
  return ~this.indexOf(element, index)
};
NodeList.prototype.map = function map () {
...
NodeList.prototype.parent = function parent () {
  return this.map(function (el) { return el.parentNode; })
};
NodeList.prototype.pop = function pop (amount) {
...
NodeList.prototype.push = function push () {
    var this$1 = this;
    var args = [], len = arguments.length;
    while ( len-- ) args[ len ] = arguments[ len ];
  ...
  for (var i in args) {
    ...
    if (!~this$1.indexOf(args[i])) { ArrayProto.push.call(this$1, args[i]); }
  }
  return this
};
NodeList.prototype.shift = function shift (amount) {
  if (typeof amount !== 'number') { amount = 1; }
  var nodes = [];
...
NodeList.prototype.slice = function slice () {
    var args = [], len = arguments.length;
    while ( len-- ) args[ len ] = arguments[ len ];

  return new NodeList([ArrayProto.slice.apply(this, args), this])
};
NodeList.prototype.splice = function splice () {
    var args = [], len = arguments.length;
    while ( len-- ) args[ len ] = arguments[ len ];
...
NodeList.prototype.unshift = function unshift () {
    var this$1 = this;
    var args = [], len = arguments.length;
    while ( len-- ) args[ len ] = arguments[ len ];
  ...
  for (var i in args) {
    if (!isNode(args[i])) { throw nodeError }
    if (!~this$1.indexOf(args[i])) { unshift(args[i]); }
  }
  return this
};

// classes
NodeList.prototype.addClass = function addClass (classes) {
  return this.toggleClass(classes, true)
};
NodeList.prototype.removeClass = function removeClass (classes) {
  return this.toggleClass(classes, false)
};
NodeList.prototype.toggleClass = function toggleClass (classes, value) {
    var this$1 = this;
  ...
  classes.forEach(function (c) { return this$1.each(function (el) { return el.classList[method](c); }); });
  return this
};

NodeList.prototype.get = function get (prop) {
    var this$1 = this;

  var arr = [];
  for (var i in this) {
    if (this$1[i] !== null) {
      this$1[i] = this$1[i][prop];
    }
    arr.push(this$1[i]);
  }
  return flatten(arr, this)
};
NodeList.prototype.set = function set (prop, value) {
    var this$1 = this;
...
NodeList.prototype.call = function call () {
    var this$1 = this;
    var args = [], len = arguments.length;
    while ( len-- ) args[ len ] = arguments[ len ];
  ...
  var returnThis = true;
  for (var i in this) {
    if (this$1[i] && this$1[i][method] instanceof Function) {
      this$1[i] = this$1[i][method].apply(this$1[i], args);
      arr.push(this$1[i]);
      if (returnThis && this$1[i] !== undefined) {
        returnThis = false;
      }
    } else {
      arr.push(undefined);
...
prototypeAccessors.asArray.get = function () {
  return ArrayProto.slice.call(this)
};

// event handlers
NodeList.prototype.on = function on (events, selector, callback) {
    var this$1 = this;
  ...
  events.forEach(function (event) {
    for (var i in this$1) {
      if (this$1[i] === window || isNode(this$1[i])) {
        this$1[i].addEventListener(event, callback, false);
        Events.push({
          el: this$1[i],
          event: event,
          callback: callback
...
NodeList.prototype.off = function off (events, callback) {
    var this$1 = this;
  ...
  if (typeof events === 'string' && callback instanceof Function) {
    var loop = function ( i ) {
      Events.forEach(function (e) {
        events.events.split(' ').forEach(function (event) {
          if (Events[e] && Events[e].el === this$1[i] && Events[e].event === event && Events[e].callback === callback) {
      ...
      for (var i in this) loop( i );
  } else if (typeof events === 'string') {
    var loop$1 = function ( i ) {
      Events.forEach(function (e) {
        events.split(' ').forEach(function (event) {
          if (Events[e] && Events[e].el === this$1[i$1] && Events[e].event === event) {
            Events[e].el.removeEventListener(Events[e].event, Events[e].callback);
            delete Events[e];
          }
        });
      ...
      for (var i$1 in this) loop$1( i );
  } else if (callback instanceof Function) {
    for (var i$2 in this) {
      for (var e in Events) {
        if (Events[e] && Events[e].el === this$1[i$2] && Events[e].callback === callback) {
          Events[e].el.removeEventListener(Events[e].event, Events[e].callback);
          delete Events[e];
        }
      }
    ...
    for (var i$3 in this) {
      for (var e$1 in Events) {
        if (Events[e$1] && Events[e$1].el === this$1[i$3]) {
          Events[e$1].el.removeEventListener(Events[e$1].event, Events[e$1].callback);
          delete Events[e$1];
        }
      }
    }
  }
  Events = Events.filter(function (el) { return el !== undefined });
  return this
};
NodeList.prototype.onBlur = function onBlur (callback) {
  if (!this || !this.length) { return this }
  if (!callback) { return this }
...
NodeList.prototype.offBlur = function offBlur (callback) {
  this.each(function (el) {
  ...
  blurList = blurList.filter(function (el) { return el !== undefined; });
  return this
};

Object.defineProperties( NodeList.prototype, prototypeAccessors );
...
function flatten (arr, owner) {
  ...
  for (var i in arr) {
    ...
    if (isNode(el)) {
      ...
      for (var id in el) { list.push(el[id]); }
    } else if (el !== null) {
      arr.get = NL.get;
      arr.set = NL.set;
      arr.call = NL.call;
    ...
    NL[prop] = function () {
      ...
      for (var i in NL) {
        ...
        if (el && el[prop] instanceof Function) {
          el = el[prop].apply(el, arguments$1);
          arr.push(el);
      ...
      return returnThis ? this$1 : flatten(arr, this$1)
    };
  } else {
...
var Dropdown$1 = {render: function(){with(this){return _h(isLi?'li':'div',{directives:[{name:"click-outside",rawName:"v-click-outside",value:(blur),expression:"blur"}],tag:"div",class:[{open:show,disabled:disabled,dropdown:isLi,'input-group-btn':inInput,'btn-group':!isLi&&!inInput}]},[_t("before"),_t("button",[(isLi)?_h('a',{class:['dropdown-toggle',buttonSize,{disabled:disabled}],attrs:{"role":"button"},on:{"keyup":function($event){if($event.keyCode!==27){ return; }show = false;}}},[_s(text)+" ",_h('span',{staticClass:"caret"})]):_h('button',{class:['btn btn-' + type,buttonSize,'dropdown-toggle'],attrs:{"type":"button","disabled":disabled},on:{"keyup":function($event){if($event.keyCode!==27){ return; }show = false;}}},[_s(text)+" ",_h('span',{staticClass:"caret"})])]),_t("dropdown-menu",[_h('ul',{staticClass:"dropdown-menu"},[_t("default")])])])}},staticRenderFns: [],
  directives: {
  ...
  watch: {
    show: function show$1 (val) { this.$emit('input', val); },
    value: function value (val) { this.show = val; }
  },
  computed: {
    buttonSize: function buttonSize$1 () { return ~['lg', 'sm', 'xs'].indexOf(this.size) ? 'btn-' + this.size : '' },
    inInput: function inInput$1 () { return this.$parent._input },
    isLi: function isLi$1 () { return this.$parent._isTabs || this.$parent._navbar || this.$parent.menu },
    menu: function menu () { return !this.$parent || this.$parent.navbar },
    slots: function slots () { return this._slotContents },
    submenu: function submenu () { return this.$parent && (this.$parent.menu || this.$parent.submenu) }
  },
  methods: {
    blur: function blur$1 () { this.show = false; }
  },
  mounted: function mounted () {
    var this$1 = this;

    var $el = NodeListJS(this.$el);
    $el.findChildren('a,button.dropdown-toggle').on('click', function (e) {
      e.preventDefault();
      if (!this$1.disabled) { this$1.show = !this$1.show; }
      return false
    });
    $el.findChildren('ul').on('click', 'li>a', function (e) { this$1.show = false; });
  },
  beforeDestroy: function beforeDestroy () {
    NodeListJS(this.$el).findChildren('a,button,ul').off();
  }
};

var Dropdown = {render: function(){with(this){return _h(isLi?'li':'div',{directives:[{name:"click-outside",rawName:"v-click-outside",value:(blur),expression:"blur"}],tag:"div",class:[{open:show,disabled:disabled,dropdown:isLi,'input-group-btn':inInput,'btn-group':!isLi&&!inInput}]},[_t("before"),_t("button",[(isLi)?_h('a',{class:['dropdown-toggle',buttonSize,{disabled:disabled}],attrs:{"role":"button"},on:{"keyup":function($event){if($event.keyCode!==27){ return; }show = false;}}},[_s(text)+" ",_h('span',{staticClass:"fa fa-ellipsis-v"})]):_h('button',{class:['btn btn-' + type,buttonSize,'dropdown-toggle'],attrs:{"type":"button","disabled":disabled,"aria-haspopup":"true","aria-expanded":"true"},on:{"keyup":function($event){if($event.keyCode!==27){ return; }show = false;}}},[_s(text)+" ",_h('span',{staticClass:"fa fa-ellipsis-v"})])]),_t("dropdown-menu",[_h('ul',{staticClass:"dropdown-menu",attrs:{"aria-labelledby":"dropdownKebab"}},[_t("default")])])])}},staticRenderFns: [],
  name: 'pf-dropdown',
  extends: Dropdown$1,
};
...
each$1(components, function (component, name) {
